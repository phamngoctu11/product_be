...
public class OrderItemMapperImpl implements OrderItemMapper {
    ...
    public OrderItemDTO toDto(OrderItem orderItem) {
        ...
        orderItemDTO.setProductId( orderItemProductVariantId( orderItem ) );
        orderItemDTO.setProductName( orderItemProductVariantVariantName( orderItem ) );
